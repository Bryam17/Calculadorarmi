...
public class Cliente {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String ip = JOptionPane.showInputDialog("Ingrese la direccion ip: ");//192.168.50.81 //192.168.50.139
            Registry registro = LocateRegistry.getRegistry(ip, 1099);
            Interfaces i = (Interfaces)Naming.lookup("//"+ip+"/Calculadora");
            ...
            JOptionPane.showMessageDialog(null, "El servidor no esta  conectado " + e.getMessage());
